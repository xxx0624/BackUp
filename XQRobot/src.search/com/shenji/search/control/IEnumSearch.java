...
public class IEnumSearch {
	...
	public static enum SearchConditionType {
		...
		public static SearchConditionType valueOf(int value)
			...
			throw new IllegalArgumentException(
					"Enum SearchConditionType Argument is Error!");
		}
	}
	...
	public static enum SearchRelationType {
		...
		public static SearchRelationType valueOf(int value)
				throws IllegalArgumentException { // 手写的从int到enum的转换函数
	...
	public static enum Fenci {
		MAX_SYN(3), MORE_SYN(4), MAX_NOSYN(1), MORE_NOSYN(2);
		private int value;
		...
		public static Fenci valueOf(int value) throws IllegalArgumentException { // 手写的从int到enum的转换函数
			...
			throw new IllegalArgumentException(
					"Enum FenciType Argument is Error!");
		}
	}
