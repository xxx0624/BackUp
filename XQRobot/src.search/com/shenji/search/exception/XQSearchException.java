...
public static enum ErrorCode {
	LuceneFileError(401), SearchDocError(402), UnKnowError(403), SynEngineError(
			405), NoSearchResult(406), SearchResultToArrayError(407);
	private int value;
	...
	public static ErrorCode valueOf(int value)
		...
		throw new IllegalArgumentException(
				"Enum ErrorCode Argument is Error!");
	}
};
 ...
 * Enum<ErrorCode> code) { super(message, cause); this.errorCode = code; //
 * "["+((ErrorCode)code).value()+"]"+ // TODO Auto-generated constructor stub }
 * 
 * }
 */