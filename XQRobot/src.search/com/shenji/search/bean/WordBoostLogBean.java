...
public class WordBoostLogBean {
	...
	public WordBoostLogBean(String user_question, String add_time,
	...
	public WordBoostLogBean(String user_question_word, String user_question_score) {
		super();
		this.user_question_word = user_question_word;
		this.user_question_score = user_question_score;
	}
