...
$(document).ready(function() {
        function e() {
            ...
            console.log(1);
            $.ajax({
                url: 'SearchServletByxxx0624',
                data: {
                    "searchTxt": encodeURI($("#textarea").val())
                },
                cache: false,
                async: false,
                type: "POST",
            ...
            var i = "<div class='message clearfix'><div class='user-logo'><img src='" 
                ...
                + "<div class='message clearfix'>" + "<div class='user-logo'>" 
                + "<img src='" 
                + c + "'/>" + "</div>" + "<div class='wrap-text'>" 
            ...
            blinkTitle: {
                show: function() {
                    ...
                    if (-1 == document.title.indexOf("\u3010")) var c = setInterval(function() {
                        a++, 3 == a && (a = 1), 1 == a && (document.title = "" + b), 2 == a && (document.title = "" + b)
                    }, 500);
                    return [c, b]
                },
                clear: function(a) {
