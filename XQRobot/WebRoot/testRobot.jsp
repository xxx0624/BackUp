...
<body onload="javascript:bodyLoad();">
	<table style="line-height:1px;" align="center">
		...
		<tr valign="middle">
			<td>
				<form id="searchForm" action="SearchServlet2_testRobot" method="post">
					<div id="dww-menu" class="mod-tab" style="margin: 0 auto;">
						...
						<div class="mod-bd" align="center">
							<div class="undis" id="sub1" style="display:block;">
								...
								<input type="radio" name="radioType_search" value="2" checked/> 普通搜索
								<!-- <input type="radio" name="radioType_search" value="3" /> 本体搜索 -->
							</div>
					...
					<div class="searchDiv" id="searchDiv" align="center"
						...
						<input type="text"
							...
							value="如：网上认证怎么下载呢s？" onfocus="javascript:inputOnfocus(this);"
							/> <input type="submit"
