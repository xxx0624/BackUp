				...
				<td>
					...
					<div align="center">
						<input type="text"
							...
							value="如：网上认证怎么下载呢？"
							onfocus="if(this.value=='如：网上认证怎么下载呢？'){this.value=''};this.style.color='black';"
							onblur="if(this.value==''||this.value=='如：网上认证怎么下载呢？'){this.value='如：网上认证怎么下载呢？';this.style.color='#808080';}" />
						<input type="submit"
